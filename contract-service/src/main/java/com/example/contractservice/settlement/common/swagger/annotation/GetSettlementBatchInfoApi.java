...
@Operation(
        summary = "정산 배치 실행 상태 조회",
        description = """
                정산 배치(settlementJob)의 최근 실행 상태를 조회합니다.
...
@Parameters({
        @Parameter(
                name = "date",
                description = "조회할 정산 배치 기준 날짜. ISO-8601 날짜 형식입니다. 예: 2026-04-18",
...
@ApiResponses({
        @ApiResponse(responseCode = "200", description = "정산 배치 실행 상태 조회 성공"),
        @ApiResponse(
                responseCode = "400",
...
public @interface GetSettlementBatchInfoApi {
